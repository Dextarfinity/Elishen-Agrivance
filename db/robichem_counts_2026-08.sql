...
INSERT INTO rc_count (where_sql, descr, pack, counted, per_box, source) VALUES
  ...
  ('name ILIKE ''%Tripulac%''', 'Tripulac Pig Doser 2x1 set', 24, 148, false, 'cotrimazine tripulac 24x100ml - 6 +1(4 left) -- the catalogue name "2x1 set" is the DOSING (two doses in the 100ml bottle), not the packing: the bottle is the sellable piece, 24 to a box. Confirmed Sept 2026'),
  ...
  ('name ILIKE ''%Robistrep Vk 5Gm%''', 'Robistrep Vk 5Gm', 96, 1344, false, 'robipenstrep 96x5g - 14 -- written down as Robipenstrep, but that is sold by dose; the 5g sachet is Robistrep VK. Confirmed Sept 2026'),
